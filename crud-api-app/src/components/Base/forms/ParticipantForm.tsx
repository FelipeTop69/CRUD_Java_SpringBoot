...
type Props = {
    ...
    onSubmit: (data: Participant) => Promise<void>;
    submitLabel?: string;
};
...
export default function ParticipantForm({ initialData, onSubmit, submitLabel = 'Guardar' }: Props) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            showError(
                error instanceof Error ? error.message : 'Error al procesar Participant'
            );
        }
    };
