...
export async function fetchAllLocation() {
    try {
        const response = await fetch("http://localhost:8080/api/v1/location/GetAll", {
            method: "GET"
        });
...
export async function fetchAllOrganizer() {
    try {
        const response = await fetch("http://localhost:8080/api/v1/organizer/GetAll", {
            method: "GET"
        });
...
export async function fetchAllCategory() {
    try {
        const response = await fetch("http://localhost:8080/api/v1/category/GetAll", {
            method: "GET"
        });
