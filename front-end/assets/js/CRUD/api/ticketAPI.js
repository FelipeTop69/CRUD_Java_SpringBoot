const API_BASE_URL = "http://localhost:8080/api/v1/ticket/";
const HEADER = {
...
export async function fetchAllTypeTicket() {
    try {
        const response = await fetch("http://localhost:8080/api/v1/typeticket/GetAll", {
            method: "GET"
        });
...
export async function fetchAllEvent() {
    try {
        const response = await fetch("http://localhost:8080/api/v1/event/GetAll", {
            method: "GET"
        });
